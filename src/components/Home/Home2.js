        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I'm Victor Zapata, a passionate programmer dedicated to
              learning and innovation.
              <br />
              <br /> I am proficient in classic languages and
              frameworks such as{' '}
              <b className="purple">
                {' '}
                C#, ASP.NET, JavaScript, and VB.NET{' '}
              </b>
              <br />
              <br />
              ...
              <b className="purple">AI</b> to harness its full
              potential.
              <br />
              <br />I enjoy building products with{' '}
              <b className="purple">Node.js</b> and modern JavaScript
              frameworks like <b className="purple">React.js</b>.
            </p>
          </Col>
